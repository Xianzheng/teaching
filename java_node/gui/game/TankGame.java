...
class Mypanel extends Panel implements KeyListener{
    ...
    public void paint(Graphics g){
       ...
       if(hero.isLive){
            this.drawTank(hero.getX(),hero.getY(),g,hero.getDirect(),1);//creates tank
        }
...
//        System.out.println("01");
    ...
    /*
     * hw:
     *  1.finish when we press a or left_arrow we can make out tank move left, and press d or right_arrow we can make out tank move right(simple)
     * 
     *  2.try to build a enemy tank in screen, (color is blue), try to control enemy tank to move(press key you can design)(harder)
     * 
     *  3*. try to use thread for enemy tank() 
     */
...
/*
 * hw, try to modify Tanks'color, position, size, direct by what ever you want
 * 
 * try to understand how the code works, base on the OOP(object oritented programming) thinking
 * 
 * give me text explaination
 * 
 *  */