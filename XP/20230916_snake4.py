...
next:
  ...
  function , class, eat food to make it bigger


Homework:

    draw apple in different position

    draw food with different color

    consider o apple in different position per 3 seconde

    look code and give me question list, and I will explain in next class
'''
