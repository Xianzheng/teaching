...
def draw():
    ...
    pygame.draw.aaline(game.screen,BRO,(100,300),(500,300),3)
    pygame.draw.aaline(game.screen,BRO,(100,300),(100,500),3)
    pygame.draw.aaline(game.screen,BRO,(100,500),(100,500),3)
    # pygame.draw.aaline(game.screen,BRO,(100,900),(500,300),3)
    # pygame.draw.aaline(game.screen,BRO,(100,300),(500,300),3)
    # pygame.draw.aaline(game.screen,BRO,(100,300),(500,300),3)
...
hw:
    use aline to draw a rectangle,

    when you press the key make whole rectangle move

    adjust today's circle move between in a range.
