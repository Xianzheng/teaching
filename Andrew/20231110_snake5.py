...
def if_end():
    ...
    for i in range(1,len(game.snake.body)):
        lst.append(game.snake.body[i].to_tuple)

    if game.snake.body[0].to_tuple() in lst:
...
'''
hw:
    1. draw a picture tp show me how the game works(or write comment

   (* plus, we want to set a variable score,how many apple we eat)
next:

    demonstate grammer surge
'''